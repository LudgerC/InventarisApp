...
namespace InventarisApp.Migrations
{
    ...
    [Migration("20260517111821_PrintersInfo")]
    partial class PrintersInfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventarisApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsActive = true,
                            PasswordHash = "$2a$11$trmcJN44Hg2T6rOxGTv7oO.r.IU.AEZsX0nWGaN2pe6oVehBfXdbC",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
